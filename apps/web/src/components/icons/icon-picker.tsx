  ...
  return (
    <div className={className}>
      <div className="flex items-center gap-2 p-2">
        <input
          type="text"
          placeholder="Search icons (folder, book, file...)"
          value={query}
      ...
      <div className="grid max-h-72 w-full gap-2 overflow-y-auto p-2 [grid-template-columns:repeat(auto-fill,minmax(2.5rem,1fr))]">
